...
const fastFibonnaci = _.memoize(n => (n < 2 ? n : fastFibonnaci(n - 1) + fastFibonnaci(n - 2))); // use memoize to create a fast fibonnaci.  Use the same
...
const getDeathstar = n => axios.get(`https://swapi.co/api/starships/${n}`);
